        ...
        var hethang1 = document.getElementsByClassName("hethang1")[0];
        var hethang2 = document.getElementsByClassName("hethang2")[0];
        var hethang3 = document.getElementsByClassName("hethang3")[0];
        var hethang4 = document.getElementsByClassName("hethang4")[0];
        var hethang5 = document.getElementsByClassName("hethang5")[0];
        var hethang6 = document.getElementsByClassName("hethang6")[0];
        ...
        hethang1.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
        hethang2.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
        hethang3.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
        hethang4.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
        hethang5.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
        hethang6.onclick = function(){
          alert("Sản phẩm đã bán hết")
        }
